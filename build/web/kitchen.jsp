...
<html>
    <head>
        ...
        <%! ArrayList dinein_list = dbOperation.getOrders("Dine_in");%>
        <%! ArrayList takeout_list = dbOperation.getOrders("Take_out");%>
    ...
    <body>
        ...
        <h2>Dine in Orders!</h2>
          ...
          <%
            if (dinein_list != null) {
                ...
                Iterator it = dinein_list.iterator();
                int i =0;
                while (it.hasNext()) {
                    OrderBean order;
            ...
            <td>
                ...
                <td>
                     ...
                     <input type="hidden" name ="ono" value= <%=order.getOrderNo()%> />   
                      <select name="status">
					<option value ="<%=order.getStatus()%>"  selected>
						<%=order.getStatus()%>
					</option>
        ...
        %>
           ...
           <h2>Take out Orders!</h2>
            ...
            <%
            if (takeout_list != null) {
             
                Iterator it = takeout_list.iterator();
                int i =0;
                while (it.hasNext()) {
                    OrderBean order;
                            order = (OrderBean) it.next();
        ...
        <tr align=center>
         ...
         <%
                    ...
                    session.removeAttribute("takeout_list");
                }
